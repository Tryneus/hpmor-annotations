...
"Wonder what's wrong with him."
    ...
    notes: [
      {
        tags: ['foreshadowing', 'speculation', 'spoiler'],
        note: `
...
Alternatively, they may simply be the most interesting and thus
...
speculative evidence at the end of {6/a last whisper from
...
face on the back of his head, covered up with a giant turban.
  ...
  {
    // TODO: this overlaps with the previous note, but the system doesn't support that
    text: `
Harry caught a glimpse of the back of his head, and it looked like
Professor Quirrell might already be going bald, despite his seeming
youth.
...
Baba Yaga
    ...
    notes: [
      {
        tags: ['spoiler', 'reference', 'departure'],
        note: `
